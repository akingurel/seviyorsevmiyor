...
class DaisyModel {
    ...
    // Yaprak sayısını güncelleme metodu
    updatePetalCount(newPetalCount) {
        // Yeni yaprak sayısını ayarla
        this.petalCount = newPetalCount;
        
        // Papatyayı sıfırla ve yeniden oluştur
        this.reset();
        
        // Yeni yaprak sayısını döndür
